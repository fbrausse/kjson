...
in the number of array or object entries. The second layer `mid' is a streaming parser API
and thus works with callbacks. In the implementation, each layer builds upon the previous.
...
For string decoding into UTF-8 (which is the defacto standard nowadays and especially suited
